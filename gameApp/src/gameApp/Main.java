...
public class Main {
	...
	public static void main(String[] args) {
		...
		gamerManager.add(new Gamer(2, "222222222", "yunus", "yavuz", LocalDate.of(1980, 5, 16)));
		gamerManager.add(new Gamer(3, "333333333", "ömer", "demir", LocalDate.of(1990, 3, 8)));
		...
		Campaign campaign = new Campaign(1, "Black Friday", LocalDate.of(2022, 01, 01), LocalDate.of(2022, 01, 27), 20.0);
